var table1 = document.getElementById("table1"); //Aqui mandamos a buscar el elemento tbody de la tabla 1
var tfoot1 = document.getElementById("tfoot1"); //Aqui mandamos a buscar el elemento tfooter de la tabla 1
...
var sumtotal = 0;//Variable de tipo contador que guardara la suma de todos los depositos
...
for (let i = 0; i < array.length; i++) {//Recorremos el arreglo de tipo deposito
    ...
    sumtotal += parseFloat(array[i]);//Luego sumaremos la cantidad de depositos hechos en el arreglo
}
...
table1.appendChild(tr);                                         //luego lo agregamos donde esta el tbody
}
...
tfoot1.appendChild(tr2);                                        //luego lo agregamos donde esta el tfooter