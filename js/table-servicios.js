var table2 = document.getElementById("table3"); //Aqui mandamos a buscar el elemento tbody de la tabla 3
var tfoot3 = document.getElementById("tfoot3"); //Aqui mandamos a buscar el elemento tfooter de la tabla 3
...
var matriz = [tipo, array];              //Creamos una matriz de acuerdo a los 2 arreglos: tipo y array
...
table3.appendChild(tr);                                         //luego lo agregamos donde esta el tbody
} 
...
tfoot3.appendChild(tr2);                                        //luego lo agregamos donde esta el tfooter